...
<body>
    ...
    <a href="insert.php" class="btn btn-info" role="button">Add Record</a>
    <a href="update.php" class="btn btn-info" role="button">Update Record</a>
    <a href="delete.php" class="btn btn-info" role="button">Delete Record</a>
    <a href="dashboard.php" class="btn btn-info" role="button">Previous Page</a>
